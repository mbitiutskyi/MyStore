...
<div class="container-wrapper">
    <div class="container">
        <div class="page-header">
            ...
            <br/>
            <h1>Add Product</h1>
            <p class="lead">Please fill up the below fields to create a new product</p>
        </div>

        <form:form method="POST" action="${pageContext.request.contextPath}/admin/product/addProduct"
