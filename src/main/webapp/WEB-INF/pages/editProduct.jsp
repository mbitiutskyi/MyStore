...
<div class="container-wrapper">
    <div class="container">
        <div class="page-header">
            ...
            <p class="lead">Please change the below values to change existing product</p>
        </div>

        <form:form method="POST" action="${pageContext.request.contextPath}/admin/product/editProduct"
        ...
        <div class="form-group">
            ...
            <h6><form:errors path="productName" cssStyle="color: red"/></h6>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <h6><form:errors path="productPrice" cssStyle="color: red"/></h6>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <h6><form:errors path="unitInStock" cssStyle="color: red"/></h6>
        </div>
        <div class="form-group">
